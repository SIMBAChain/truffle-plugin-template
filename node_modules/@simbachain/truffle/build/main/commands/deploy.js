...
exports.deployContract = exports.handler = exports.builder = exports.describe = exports.command = void 0;
...
exports.handler = async (args) => {
    ...
    const deployArgs = args.args ? JSON.parse(args.args) : undefined;
    let deployInfo;
 ...
 * @returns
 */
async function deployContract(primary, deployInfo) {
    const entryParams = {
        primary,
        deployInfo,
    };
    web3_suites_1.SimbaConfig.log.debug(`:: ENTER : args: ${JSON.stringify(entryParams)}`);
