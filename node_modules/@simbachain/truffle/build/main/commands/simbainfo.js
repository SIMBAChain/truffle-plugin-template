...
exports.getSimbaInfo = exports.handler = exports.builder = exports.describe = exports.command = void 0;
 ...
 * @returns
 */
function getSimbaInfo(contract, field) {
    const params = {
        contract,
        field,
    };
    web3_suites_1.SimbaConfig.log.debug(`:: ENTER : ${JSON.stringify(params)}`);
    if (!contract && !field) {
