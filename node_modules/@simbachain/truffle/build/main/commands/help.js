...
exports.help = exports.handler = exports.builder = exports.describe = exports.command = void 0;
...
(function (HelpCommands) {
    ...
    HelpCommands["CICD"] = "cicd";
    HelpCommands["CLEAN"] = "clean";
    HelpCommands["SIMBAINFO"] = "simbainfo";
    HelpCommands["GETDIRS"] = "getdirs";
    HelpCommands["SETDIR"] = "setdir";
    HelpCommands["RESETDIR"] = "resetdir";
    HelpCommands["DELETECONTRACT"] = "deletecontract";
...
async function help(topic) {
    ...
    switch (helpTopic) {
        ...
        default: {
            web3_suites_1.SimbaConfig.log.error(`${chalk_1.default.cyanBright(`Please enter a valid topic from these choices: ${chalk_1.default.greenBright(`${JSON.stringify(paramInputChoices)}.`)} For example, run '$ truffle run simba help --topic deploy' for help deploying your contract.`)}`);
            break;
        }
    }
}
